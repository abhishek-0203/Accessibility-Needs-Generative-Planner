...
import { isValidEmail, isValidPassword, isRequired, passwordsMatch } from '../../utils/validators'
...
export default function RegisterForm() {
  ...
  const validate = () => {
    ...
    else if (!isValidPassword(formData.password)) newErrors.password = 'Min 8 characters with at least one letter and one number'
    if (!passwordsMatch(formData.password, formData.confirmPassword)) newErrors.confirmPassword = 'Passwords do not match'
    setErrors(newErrors)
